...
if __name__ == '__main__':
    ...
    print("Starting tests on number of assignments")
   ...
   #  num_known
    for j in tqdm(range(1)):
        for i in range(81):
           ...
           test_board = np.copy(hard_solution)
           test_board = test_board.reshape(81)

           mask = mask.reshape(81)
           test_board[mask==0] = 0

           test_board = test_board.reshape([9,9])
           print(test_board)
